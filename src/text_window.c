...
{
    const struct TextWindowGraphics *frame = GetUserWindowGraphics(frameType);
    LoadBgTiles(bgId, frame->tiles, 0x120, destOffset);
    LoadPalette(frame->palette, palOffset, PLTT_SIZE_4BPP);
}
