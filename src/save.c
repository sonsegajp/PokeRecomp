...
{
#ifdef PORTABLE
    u32 sectorOffset = sectorNum * 0x1000;
    memcpy(&FLASH_BASE[sectorOffset], data, 0x1000);
...
u8 LoadGameSave(u8 saveType)
{
    ...
    UpdateSaveAddresses();
#ifdef PORTABLE
    printf("[LoadGameSave] type=%d sb2=%p sb1=%p storage=%p\n",
           saveType, (void*)gSaveBlock2Ptr, (void*)gSaveBlock1Ptr, (void*)gPokemonStoragePtr);
#endif
    switch (saveType)
    {
    case SAVE_NORMAL:
