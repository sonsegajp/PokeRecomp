...
const u8 gItemDescription_ITEM_SHINY_CHARM[] = _("A charm said to increase the\nchance of meeting a SHINY\nPOKéMON in the wild.");
const u8 gItemDescription_ITEM_POKE_RADAR[] = _("A tool that can search out\nPOKéMON hiding in tall grass.\nIts battery is recharged by walking.");
extern void FieldUseFunc_PokeRadar(u8);
