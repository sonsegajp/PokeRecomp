...
#else /* PORTABLE */
#include "../../hoenn-postgame/encounter_arrays.h"
const struct WildPokemonHeader gWildMonHeaders_FR[] =
{
    {
        .mapGroup = MAP_GROUP(MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER),
        .mapNum = MAP_NUM(MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER),
...
#include "../../hoenn-postgame/encounter_headers.h"
    {
        .mapGroup = MAP_GROUP(MAP_UNDEFINED),
        .mapNum = MAP_NUM(MAP_UNDEFINED),
        .landMonsInfo = NULL,
...
const struct WildPokemonHeader gWildMonHeaders_LG[] =
{
    {
        .mapGroup = MAP_GROUP(MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER),
        .mapNum = MAP_NUM(MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER),
