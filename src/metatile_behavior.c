...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_CYCLING_ROAD_PULL_DOWN_GRASS || metatileBehavior == 0x03 || metatileBehavior == 0x24)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsLongGrass(u8 metatileBehavior) { return metatileBehavior == 0x03; }
bool8 MetatileBehavior_IsAshGrass(u8 metatileBehavior) { return metatileBehavior == 0x24; }
