...
{
#ifdef PORTABLE
    if (!gQuestLogRecordingPointer) return;
#endif
...
void TryStartQuestLogPlayback(u8 taskId)
{
    ...
    {
#ifdef PORTABLE
        printf("[TryStartQuestLogPlayback] sNumScenes=%d, SHOULD NOT REACH ON PORTABLE!\n", sNumScenes); fflush(stdout);
#endif
    ...
    {
#ifdef PORTABLE
        printf("[TryStartQuestLogPlayback] sNumScenes=0, calling CB2_ContinueSavedGame\n"); fflush(stdout);
#endif
