...
u16 RenderText(struct TextPrinter *textPrinter)
{
    ...
    case RENDER_STATE_HANDLE_CHAR:
        ...
        case EXT_CTRL_CODE_BEGIN:
            ...
            {
                u8 paletteNum = *textPrinter->printerTemplate.currentChar;
                textPrinter->printerTemplate.currentChar++;
                PutWindowRectTilemapOverridePalette(
                    textPrinter->printerTemplate.windowId,
                    0, 0,
                    gWindows[textPrinter->printerTemplate.windowId].window.width,
                    gWindows[textPrinter->printerTemplate.windowId].window.height,
                    paletteNum);
                return RENDER_REPEAT;
            }
