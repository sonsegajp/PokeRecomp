...
#endif
#ifdef PORTABLE
const u16 gGraphics_TitleScreen_LG_GameTitleLogoPals[] = INCBIN_U16("graphics/title_screen/leafgreen/game_title_logo.gbapal");
const u8 gGraphics_TitleScreen_LG_GameTitleLogoTiles[] = INCBIN_U8("graphics/title_screen/leafgreen/game_title_logo.8bpp.lz");
const u8 gGraphics_TitleScreen_LG_GameTitleLogoMap[] = INCBIN_U8("graphics/title_screen/leafgreen/game_title_logo.bin.lz");
const u16 gGraphics_TitleScreen_LG_BoxArtMonPals[] = INCBIN_U16("graphics/title_screen/leafgreen/box_art_mon.gbapal");
const u8 gGraphics_TitleScreen_LG_BoxArtMonTiles[] = INCBIN_U8("graphics/title_screen/leafgreen/box_art_mon.4bpp.lz");
const u8 gGraphics_TitleScreen_LG_BoxArtMonMap[] = INCBIN_U8("graphics/title_screen/leafgreen/box_art_mon.bin.lz");
const u16 gGraphics_TitleScreen_LG_BackgroundPals[] = INCBIN_U16("graphics/title_screen/leafgreen/background.gbapal");
const u16 gTitleScreen_LG_Slash_Pal[] = INCBIN_U16("graphics/title_screen/leafgreen/slash.gbapal");
#endif
